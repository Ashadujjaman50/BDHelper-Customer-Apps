...
public class BidSkilledLaborFragment extends Fragment implements BidCustomerAdapter.OnBidActionListener {
    ...
    private void dataUploadInDatabase(ServiceModel model) {
        ...
        db.collection("bidForOrder")
                ...
                .addOnSuccessListener(aVoid->{
                    ...
                    //Custome Notice Send
                    String finalBidAmount = CommonClass.getRoundedTenPercentValue(bidAmount, 5);

...
public class SelectServiceCategoryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        subCategoryAdapter = new AdapterSubCategory(subCategoryModelList, getContext());
    ...
    private void getSubCategoryList() {
        ...
        //Harvester
        allList.add(new SubCategoryModel(MyUtils.HARVESTER_MACHINE_ID, MyUtils.HARVESTER_MACHINE_ID, getString(R.string.harvester), R.drawable.ic_harvester, false));
        ...
        //Home shifting
        allList.add(new SubCategoryModel(MyUtils.HOME_SHIFTING_ID, MyUtils.HOME_SHIFTING_ID, getString(R.string.home_office_shifting), R.drawable.ic_home_shift, false));
        ...
        subCategoryModelList.addAll(allList);

package com.krishibarirangpur.bdhelper.userFragment.customer.authFragment;
...
public class CustomerRegisterFragment extends Fragment {
    ...
    private FragmentCustomerRegisterBinding binding;
    ...
    private void registrationCustomerInfo() {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            Toast.makeText(requireActivity(), "আপনার ১১ ডিজিটের মোবাইল নাম্বার দিন", Toast.LENGTH_SHORT).show();
        }

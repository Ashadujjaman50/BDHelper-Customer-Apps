...
import com.dropshep.bdhelper.adapter.AdapterChat;
import com.dropshep.bdhelper.databinding.ActivityChatBinding;
import com.dropshep.bdhelper.model.ModelChat;
...
public class ChatActivity extends BaseActivity {
    ...
    String hisImage = "https://firebasestorage.googleapis.com/v0/b/bd-helper.firebasestorage.app/o/Asset%2Fbdhelper%20logo.png?alt=media&token=a6996c25-026c-4148-b16a-b5ad0903f2af";
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    if (chat.getReceiver().equals(currentUid) && chat.getSender().equals(receiverUid) ||
